                ...
                $.each(data,function(idx,obj){
                    html+=`
                        <li>
                            <dl>
                                <dt>
                                    <a href="led-light.html"><img src="${obj.fpic}"/></a>
                                    <a href="led-light.html">免费申请</a>
                                </dt>
            ...
            success:function(data){
                ...
                $.each(data,function(idx,obj){
                    html+=`
                        <li>
                                <dl>
                                    <dt><a href="lip.html"><img src="${obj.pic}" alt=""/></a></dt>
                                    <dd><a href="lip.html">${obj.pname}</a></dd>
            ...
            success:function(data){
                ...
                $.each(data,function(idx,obj){
                    html+=`
                        <li>
                                <dl>
                                    <dt><a href="back.html"><img src="${obj.pic}" alt=""/></a></dt>
                                    <dd><a href="back.html">${obj.mname}</a></dd>
                                    <dd>限量： ${obj.copies}份</dd>
                                    <dd>
                                        <span>奖励：&yen;${obj.packet}</span>
                                        <a href="back.html">立即参与</a>
                                    </dd>
                                </dl>
                            </li>
                        `;
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(idx,obj){
                    html+=`
                        <dl>
                            <dt><a href="led-light.html"><img src="${obj.fpic}"/><b></b></a></dt>
                            <dd class="firstDd"><a href="led-light.html">${obj.fname}</a></dd>
                            <dd class="lastDd">
                                <span><b class="bColor">&yen;<b class="bFont">${obj.price}</b></b> <s class="sGray">&yen;${obj.price}</s> 限量：${obj.copies}份</span>
                                <a href="led-light.html" class="aColor">
                                    免费申请
                                    <b class="rect"></b>
                                </a>
                            </dd>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(idx,obj){
                    html+=`
                        <dl>
                            <dt><a href="lip.html"><img src="${obj.pic}"/><b></b></a></dt>
                            <dd class="firstDd"><a href="lip.html">${obj.pname}</a></dd>
                            <dd class="lastDd">
                                <span><b class="bColor">&yen;<b class="bFont">${obj.packet}</b></b> <s class="sGray">&yen;${obj.price}</s> 限量：${obj.copies}份</span>
                                <a href="lip.html" class="aColor">
                                    免费参与
                                    <b class="rect"></b>
                                </a>
                            </dd>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(idx,obj){
                    html+=`
                        <dl>
                            <dt><a href="back.html"><img src="${obj.pic}"/><b></b></a></dt>
                            <dd class="firstDd"><a href="back.html">${obj.mname}</a></dd>
                            <dd class="lastDd">
                                <span ><b class="bColor">&yen;<b class="bFont">${obj.packet}</b></b> <s class="sGray">&yen;${obj.price}</s> 限量：${obj.copies}份</span>
                                <a href="back.html" class="aColor">
                                    免费参与
                                    <b class="rect"></b>
                                </a>
                            </dd>
